  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_nsuko84", "template_3a8r92i", form.current, {
        publicKey: publicKeys, // Use environment variable for API key
      })
      .then(
        () => {
          console.log("Email sent"); // Log success message
          toast.success("Your Message was sent successfully!"); // Display success toast
        ...
        (error) => {
          ...
          toast.error("FAILED...", error.text); // Display error toast
        }
      );
  };
