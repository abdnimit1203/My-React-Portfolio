  ...
  return (
    <div name="about" id="about" data-aos="fade-down"  data-aos-duration="600">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-6">
        ...
        <div className=" text-lg md:text-xl md:w-3/4" data-aos="fade-up"  data-aos-duration="1200">
          <p className="hover:scale-110 ease-in-out transition cursor-pointer rounded-lg hover:border p-4 " data-aos="fade-up"  data-aos-duration="1200">
